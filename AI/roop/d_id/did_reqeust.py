...
FACESWAP_IMAGE_PATH = "./image/faceswap_image"
...
class DIdAPI:
    ...
    def upload_scene(self, s3_image_url, text, voice_id):
        ...
        headers = {
            ...
            "authorization": "Basic" + " " + self.config.DID_API_KEY,  # 유저 API 키
            "x-api-key-external": f'{{"elevenlabs": "{self.config.ELEVENLABS_API_KEY}"}}'
    ...
    def download_scene(self, talk_id):
        ...
        for i in range(1, 11):
            headers = {
                "accept": "application/json",
                "authorization": "Basic" + " " + self.config.DID_API_KEY
            }
    ...
    def upload_image(self, face_swap_image_name):
        ...
        files = {
            "image": (face_swap_image_name, open(FACESWAP_IMAGE_PATH + "/" + face_swap_image_name, "rb"), "image/jpeg")}
        headers = {
            "accept": "application/json",
            "authorization": "Basic" + " " + self.config.DID_API_KEY
        }
