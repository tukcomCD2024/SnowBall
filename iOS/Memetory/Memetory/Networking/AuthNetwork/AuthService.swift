...
//        authRequest( router: AuthRouter.kakao(authCode: authCode), completion: completion)
        requestReturnsNoData(router: AuthRouter.kakao(authCode: authCode), completion: completion)
    }
...
//        authRequest( router: AuthRouter.google(authCode: authCode), completion: completion)
        requestReturnsNoData(router: AuthRouter.google(authCode: authCode), completion: completion)
    }
}
